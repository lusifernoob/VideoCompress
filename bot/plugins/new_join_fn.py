    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton('creator', url='https://t.me/shado_hackers'), # Bloody Thief, Don't Become a Developer by Stealing other's Codes & Hard Works!
                    InlineKeyboardButton('log channel', url='https://t.me/videocom_v1') # Must Give us Credits!
                ]
            ]
        ),
        quote=True
